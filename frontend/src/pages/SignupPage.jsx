  ...
  return (
    <div className="min-h-screen bg-dark-500 flex items-center justify-center p-4">
      <div className="absolute inset-0 overflow-hidden pointer-events-none">
        ...
        <div className="absolute bottom-1/4 left-1/4 w-96 h-96 bg-brand-blue/5 rounded-full blur-3xl" />
      </div>
      <motion.div
      ...
      >
        <div className="text-center mb-8">
          ...
          <p className="text-gray-400 mt-2">Create your free Expensio AI account</p>
        </div>
